...
$lang['btn_eventi']="News and Events";
...
$lang['index_text0']="<p class=\"pJustify\">Since 1903 Crova family produces in Sala Monferrato (AL) tipical Monferrato Casalese's wines.<br/>
...
$lang['azienda_text0']="<p class=\"pJustify\">Since 1903 Crova family produces in Sala Monferrato (AL) tipical Monferrato Casalese's wines.<br/>
    ...
    Our farm produces various wines, from classics: Barbera del Monferrato DOC, Monferrato Freisa DOC,
    Grignolino del Monferrato Casalese DOC, Monferrato Dolcetto, Monferrato Freisa to whites, rosè, red wines.</p>
    <p class=\"pCenter\">Our excellences are:</p>
    <ul><li><p class=\"pJustify\">the “Barbera del Monferrato Superiore DOCG” refined in oak barrels for 11 months;</p></li>
    <li><p class=\"pJustify\">the “Monferrato Rosso Notu”, grandad's wine, a barbera made from premium grapes from an old vineyard from 1923. <br/>
    We wanted, with the label, to dedicate this wine to Notu, great-great-grandad founder of our winery; for this reason his face is on the label.</p></li>
    <li><p class=\"pJustify\">“Lo sfizioso” a particular wine you can tell from the name (delicious). In an old vineyard bought by friars was found aleatico vines,
    usually found in Isola d'Elba or Puglia. The plants where multiplied by buds until we had enough for a cultivated surface of an hectar
    from which we obtain this brightly colored wine, with perfumes and flavours strong and fruity, refined in oak barrels for 3 months;</p></li>
